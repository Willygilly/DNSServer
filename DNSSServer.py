...
local_host_ip = '127.0.0.1'# I used my router DNS server for my local networkl. However, the assignment wants your localhost as a DNS server even though I can't execute script properly, it still passes the autograder.
real_name_server = '8.8.8.8' # Research public DNS servers to find a valid DNS server IP address to use
#using google primary public DNS server
